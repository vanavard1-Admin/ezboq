            ...
            return (
              ...
              >
                ...
                >
                  {/* Gradient Overlay */}
                  <motion.div
                    className={`absolute inset-0 bg-gradient-to-br ${doc.hoverGradient} opacity-0 hover:opacity-10 transition-opacity duration-300`}
                  ...
                  <div className="relative p-6 sm:p-8 flex flex-col items-center text-center h-full">
                    ...
                    {/* Button */}
                    <Button
                      className={`w-full bg-gradient-to-r ${doc.gradient} hover:${doc.hoverGradient} text-white shadow-lg group`}
                      onClick={(e) => {
                        e.stopPropagation();
                        onSelect(doc.type);
                      }}
                  ...
                  {/* Corner Decoration */}
                  <div className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${doc.gradient} opacity-10 blur-2xl`} />
                  <div className={`absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tl ${doc.gradient} opacity-10 blur-2xl`} />
                </Card>
              </motion.div>
            );
          })}
