...
export function ReceiptPageEnhanced({
  ...
  const handleExportReceiptForInstallment = async (installmentNumber: number) => {
    ...
    try {
      ...
      // สำหรับงวดชำระ เราไม่จำเป็นต้องบันทึกเอกสารใหม่ทุกครั้ง
  ...
  const handleExportAllDocuments = async () => {
    ...
    try {
      ...
      toast.success("ส่งออกเอกสารทั้งชุดและบันทึกสำเร็จ! 🎉", {
        description: "ดาวน์โหลดไฟล์ BOQ, ใบเสนอราคา, ใบวางบิล และใบเสร็จแล้ว และบันทึกไปประวัติเอกสารและหน้าภาษีแล้ว",
        duration: 5000,
      });
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 pb-20">
      {/* Page Header */}
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 text-white p-4 sm:p-6 md:p-8 shadow-xl">
        <div className="container mx-auto">
          <div className="flex items-center gap-3 sm:gap-4 mb-3">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-lg sm:text-2xl md:text-3xl mb-1 truncate">ใบกำกับภาษี/ใบเสร็จ (Tax Invoice/Receipt)</h1>
              <p className="text-xs sm:text-sm text-green-100 line-clamp-2">ขั้นตอนที่ 4: จัดการใบกำกับภาษีและใบเสร็จรับเงิน</p>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-6 md:py-8">
        <div id="receipt-content" className="grid gap-4 sm:gap-6">
          {/* Project Summary */}
          <Card className="p-4 sm:p-6 bg-white/80 backdrop-blur-sm shadow-lg border-green-100">
          ...
          <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
            ...
            <Card 
              ...
              className="p-4 sm:p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200 shadow-lg h-fit"
            >
              <h3 className="mb-3 sm:mb-4 bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent text-base sm:text-lg md:text-xl">
                สถานะการชำระเงิน
              </h3>
