...
export function InvoicePage({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50 pb-20">
      {/* Page Header */}
      <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-4 sm:p-6 md:p-8 shadow-xl">
        <div className="container mx-auto">
          <div className="flex items-center gap-3 sm:gap-4 mb-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs sm:text-sm text-orange-100 line-clamp-2">ขั้นตอนที่ 3: จัดการแผนชำระเงินและข้อมูลธนาคาร</p>
            </div>
          </div>
