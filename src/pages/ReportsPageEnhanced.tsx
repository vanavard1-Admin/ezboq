...
export function ReportsPageEnhanced({ onBack }: ReportsPageEnhancedProps) {
    ...
    try {
      ...
      if (data) {
        ...
        const safeData = {
          ...
          recentDocuments: data.recentDocuments || [], // ✅ FIX: Ensure array
        };
  ...
  const loadProjectSummaries = async () => {
    try {
      ...
      console.log('📊 Loading project summaries (cache-first)...');
      const data = await api.get('/documents?limit=20');

      if (data?.documents) {
        console.log(`📊 Documents loaded for reports:`, data.documents?.length || 0);
        ...
        setProjectSummaries([]);
        console.log('ℹ️ No cached project summaries available');
      }
    } catch (error) {
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-xl sm:text-2xl md:text-3xl truncate">รายงานและวิเคราะห์</h1>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
              ...
              >
                <Card className="p-3 sm:p-4 md:p-6 bg-gradient-to-br from-blue-500 to-blue-600 text-white">
                  ...
                  <p className="text-xs sm:text-sm opacity-90 mb-0.5 sm:mb-1 truncate">กำไร (ยอดขาย)</p>
              ...
              >
                <Card className="p-3 sm:p-4 md:p-6 bg-gradient-to-br from-red-500 to-red-600 text-white">
                  ...
                  <p className="text-xs sm:text-sm opacity-90 mb-0.5 sm:mb-1 truncate">ต้นทุน (พาร์ทเนอร์)</p>
              ...
              >
                <Card className="p-3 sm:p-4 md:p-6 bg-gradient-to-br from-green-500 to-green-600 text-white">
                  ...
                  <p className="text-xs sm:text-sm opacity-90 mb-0.5 sm:mb-1 line-clamp-2">รายได้สุทธิ (หลังหักภาษี)</p>
