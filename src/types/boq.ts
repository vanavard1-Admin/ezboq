...
export interface Document {
  ...
  approvedAt?: number; // วันที่อนุมัติ
...
export interface AnalyticsData {
  ...
  retentionAmount?: number; // เงินประกัน 5%
  warrantyAmount?: number; // งานประกัน 3%
  vatAmount?: number; // VAT 7%
  netProfitBeforeTax?: number; // กำไรสุทธิก่อนหักภาษี
  netProfitAfterTax?: number; // กำไรสุทธิหลังหักภาษี
