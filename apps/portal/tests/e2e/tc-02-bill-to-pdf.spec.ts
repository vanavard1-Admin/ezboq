...
test.describe('TC-02: BILL to PDF', () => {
  ...
  test('should create BILL and generate PDF', async ({ page }) => {
    ...
    if (await subjectInput.isVisible()) {
      await subjectInput.fill('Test Billing Note');
    }
    ...
    await itemDescription.fill('Service Item');
