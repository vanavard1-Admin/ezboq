...
import { ConstructionInvoiceDocument } from './ConstructionInvoiceDocument';
import { ConstructionContractorInvoiceDocument } from './ConstructionContractorInvoiceDocument';
import { ConstructionWorkPlanDocument } from './ConstructionWorkPlanDocument';
...
export function ConstructionDocumentsPage() {
  ...
  const project = useMemo(
    () => loadProjectById('construction-floor-masonry'),
    [],
  );
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-[1200px] mx-auto px-4 py-3">
          ...
          <div className="flex gap-2 overflow-x-auto">
            ...
            >
              ...
              <span className="text-sm">ใบแจ้งหนี้ผู้รับเหมา</span>
            </button>
            <button
      ...
      <div className="max-w-[1200px] mx-auto p-4">
        <div className="bg-white rounded-lg shadow-lg">
          ...
          {activeDoc === 'invoice' && <ConstructionInvoiceDocument project={project} />}
          {activeDoc === 'contractor-invoice' && <ConstructionContractorInvoiceDocument project={project} />}
          {activeDoc === 'workplan' && <ConstructionWorkPlanDocument project={project} />}
      ...
      <div className="max-w-[1200px] mx-auto px-4 pb-4 print:hidden">
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-lg shadow-lg p-6">
          <h2 className="text-xl mb-4">📊 สรุปราคาโครงการ</h2>
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <p className="text-orange-200 text-sm mb-1">ต้นทุนรวม</p>
              <p className="text-2xl">92,900 บาท</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <p className="text-orange-200 text-sm mb-1">เสนอลูกค้า (+25%)</p>
              <p className="text-2xl">116,125 บาท</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <p className="text-orange-200 text-sm mb-1">รวมค่าดำเนินการ 5%</p>
              <p className="text-2xl">121,931 บาท</p>
            </div>
          </div>
          <div className="mt-4 text-sm text-orange-100">
            <p>✓ รวมค่าวัสดุและค่าแรงทุกหมวดแล้ว (A-D)</p>
            <p>✓ บวกกำไร 25% ทุกหมวด</p>
            <p>✓ บวกค่าดำเนินการ 5%</p>
          </div>
        </div>
      </div>
    </div>
