...
export function Phase3DocumentsPage() {
  ...
  const project = useMemo(
    () => loadProjectById('phase3-electrical-ceiling-plumbing'),
    [],
  );
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-[1200px] mx-auto px-4 pb-4 print:hidden">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg shadow-lg p-6">
          <h2 className="text-xl mb-4">📊 สรุปราคาโครงการ Phase 3</h2>
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <p className="text-blue-200 text-sm mb-1">ต้นทุนรวม</p>
              <p className="text-2xl">171,137 บาท</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <p className="text-blue-200 text-sm mb-1">เสนอลูกค้า (+25%)</p>
              <p className="text-2xl">213,921 บาท</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              <p className="text-blue-200 text-sm mb-1">รวมค่าดำเนินการ 5%</p>
              <p className="text-2xl">224,618 บาท</p>
            </div>
          </div>
          <div className="mt-4 text-sm text-blue-100">
            <p>✓ E) งานระบบไฟฟ้า: 85,400 บาท</p>
            <p>✓ F) งานฝ้า: 72,737 บาท</p>
            <p>✓ G) งานระบบประปา: 13,000 บาท</p>
          </div>
        </div>
      </div>
    </div>
